...
class _AdminMainScreenState extends State<AdminMainScreen> {
  ...
  List<Widget> get _adminPages => [
        ...
        AdminHistory(userName: widget.userName, userEmail: widget.userEmail, userRole: widget.userRole),
        AdminInvoice(userName: widget.userName, userEmail: widget.userEmail, userRole: widget.userRole),
        AdminProfile(userName: widget.userName, userEmail: widget.userEmail, userRole: widget.userRole),
      ];
