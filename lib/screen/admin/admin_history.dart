import 'package:asset_management/screen/admin/admin_history_detail.dart';
...
class _AdminHistoryState extends State<AdminHistory> with SingleTickerProviderStateMixin {
      ...
      child: CustomCard(
        ...
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => AdminHistoryDetailScreen(
