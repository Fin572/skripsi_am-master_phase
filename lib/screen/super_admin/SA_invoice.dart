...
import 'package:asset_management/screen/super_admin/SA_invoice_detail.dart';
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  // Icon for the title (using web_asset as per previous request).
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: status == 'Paid' ? Colors.green.shade100 : Colors.red.shade100, // Light green/red background based on status.
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                        fontSize: 12.0,
                        fontWeight: FontWeight.bold,
                        color: status == 'Paid' ? Colors.green.shade700 : Colors.red.shade700, // Darker green/red text.
                      ),
                    ),
                  ),
                ],
...
class SuperAdminInvoice extends StatefulWidget {
  ...
  @override
  State<SuperAdminInvoice> createState() => _InvoiceState();
}

class _InvoiceState extends State<SuperAdminInvoice> with SingleTickerProviderStateMixin {
    ...
    return Padding(
      ...
      child: CustomCard(
        ...
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => SuperAdminInvoiceDetail(status: cardData['status']!)), // Pass actual status
          );
        },
      ),
    );
